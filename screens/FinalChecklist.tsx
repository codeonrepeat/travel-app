...
// // Friendly checklist steps with descriptions
...
//   // Fetch order details and checklist steps from DB
...
//       // If no checklist steps exist, create defaults
...
//         // Reload checklist steps after insert
...
//   // Mark order as ready once all steps are complete
...
//         contentContainerStyle={{ paddingBottom: 180 }} // Give room for floating card and button
//       >
//         <Text style={styles.title}>Final Checklist</Text>

//         {/* New user friendly blurb */}
...
//             </Text>
//             {/* <Text style={styles.cardText}>City: {order.trip_city}</Text> */}
//             <Text style={styles.cardText}>
...
//       {/* Floating Button */}
//       <TouchableOpacity
//         style={[styles.button, (!allCompleted || updatingReady) && styles.buttonDisabled]}
//         onPress={handleConfirmReady}
//         disabled={!allCompleted || updatingReady}>
//         {updatingReady ? (
